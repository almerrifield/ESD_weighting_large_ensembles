...
dsP_DA_djf = select_season_and_groupby_season_year(dsP_DA, "DJF").mean('time')
dsPm_DA_djf = select_season_and_groupby_season_year(dsPm_DA, "DJF").mean('time')
...
dsPobs1_DA_djf = select_season_and_groupby_season_year(dsPobs1_DA, "DJF").mean('time')
...
ds_psl_DJF = dict(
        ...
        MPI=dsPm_DA_djf,
        CanESM=dsPn_DA_djf,
        ERA20C=dsPobs_DA_djf,
        BEST=dsPobs1_DA_djf,
        CMIP5=dsPc_DA_djf)


plot_scatter_CLIM(ds_psl_DJF, 'psl_hPa', 1950, 1969, 2080, 2099)
r_value_cmip = plot_fit_CLIM(ds_psl_DJF, 'psl_hPa', 1950, 1969, 2080, 2099,'CMIP5', color='b')
r_value_all = plot_fit_CLIM(ds_psl_DJF, 'psl_hPa', 1950, 1969, 2080, 2099,color='k')
plt.xlabel('DJF European Sector Mean SLP (hPa), 1950-1969')
plt.ylabel('DJF European Sector Mean SLP (hPa), 2080-2099')
plt.xlim(1013, 1023)
plt.ylim(1013, 1023)
...
plt.savefig('ESD_figC1_slp_a.png', dpi=300)
plt.close()

plot_scatter_CLIM(ds_psl_DJF, 'psl_hPa', 1990, 2009, 2080, 2099)
r_value_cmip = plot_fit_CLIM(ds_psl_DJF, 'psl_hPa', 1990, 2009, 2080, 2099, 'CMIP5', color='b')
r_value_all = plot_fit_CLIM(ds_psl_DJF, 'psl_hPa', 1990, 2009, 2080, 2099, color='k')
plt.xlabel('DJF European Sector Mean SLP (hPa), 1990-2009')
plt.ylabel('DJF European Sector Mean SLP (hPa), 2080-2099')
plt.xlim(1013, 1023)
plt.ylim(1013, 1023)
plt.gca().set_aspect('equal', adjustable='box')
plt.figtext(.49, .9, f'R$^2$={r_value_cmip**2:.2f}', fontsize='large', color='b', ha='right')
plt.figtext(.51, .9, f'R$^2$={r_value_all**2:.2f}', fontsize='large', color='k', ha='left')
plt.savefig('ESD_figC1_slp_b.png', dpi=300)
plt.close()
...
plot_scatter_STD(ds_psl_DJF, 'psl_hPa', 1950, 1969, 2080, 2099)
r_value_cmip = plot_fit_STD(ds_psl_DJF, 'psl_hPa', 1950, 1969, 2080, 2099,'CMIP5', color='b')
r_value_all = plot_fit_STD(ds_psl_DJF, 'psl_hPa', 1950, 1969, 2080, 2099,color='k')
plt.xlabel('DJF European Sector SLP Std. Dev. (hPa), 1950-1969')
plt.ylabel('DJF European Sector SLP Std. Dev. (hPa), 2080-2099')
plt.xlim(2, 4)
plt.ylim(2, 4)
plt.gca().set_aspect('equal', adjustable='box')
plt.figtext(.49, .9, f'R$^2$={r_value_cmip**2:.2f}', fontsize='large', color='b', ha='right')
plt.figtext(.51, .9, f'R$^2$={r_value_all**2:.2f}', fontsize='large', color='k', ha='left')
plt.savefig('ESD_figC1_slp_c.png', dpi=300)
plt.close()

plot_scatter_STD(ds_psl_DJF, 'psl_hPa', 1990, 2009, 2080, 2099)
r_value_cmip = plot_fit_STD(ds_psl_DJF, 'psl_hPa', 1990, 2009, 2080, 2099, 'CMIP5', color='b')
r_value_all = plot_fit_STD(ds_psl_DJF, 'psl_hPa', 1990, 2009, 2080, 2099, color='k')
plt.xlabel('DJF European Sector SLP Std. Dev. (hPa), 1990-2009')
plt.ylabel('DJF European Sector SLP Std. Dev. (hPa), 2080-2099')
plt.xlim(2, 4)
plt.ylim(2, 4)
plt.gca().set_aspect('equal', adjustable='box')
plt.figtext(.49, .9, f'R$^2$={r_value_cmip**2:.2f}', fontsize='large', color='b', ha='right')
plt.figtext(.51, .9, f'R$^2$={r_value_all**2:.2f}', fontsize='large', color='k', ha='left')
plt.savefig('ESD_figC1_slp_d.png', dpi=300)
plt.close()
